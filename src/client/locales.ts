...
export const zh = {
  ...
  viewerHtml: 'HTML',
  browser: '浏览器',
  wayfinder: 'Wayfinder 地图',
  wayfinderChecking: '正在检查 Wayfinder 服务…',
  wayfinderNotRunning: 'Wayfinder 服务未运行',
  wayfinderStartHint: '在 DSH 所在机器的终端执行以下命令启动服务（保持运行），然后点「重试」：',
  wayfinderCopy: '复制启动命令',
  wayfinderCopied: '已复制',
  wayfinderRetry: '重试',
  wayfinderListOpen: '待办',
  wayfinderListClaimed: '认领中',
  wayfinderListResolved: '已解决',
  wayfinderListOutOfScope: '已排除',
  wayfinderListEmpty: '未找到票',
  wayfinderToggleMap: '星图',
  wayfinderToggleList: '列表',
  plan: '计划',
  planToggleGraph: '依赖图',
  wayfinderListPathHint: '当前目录未找到 .plan，请在对话中用 openTab({ type: \"wayfinder\", path: \"/path/to/.plan\" }) 指定路径',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  wayfinderChecking: 'Checking the Wayfinder server…',
  wayfinderNotRunning: 'Wayfinder server is not running',
  wayfinderStartHint: 'Run the following in a terminal on the DSH machine (keep it running), then retry:',
  wayfinderCopy: 'Copy start command',
  wayfinderCopied: 'Copied',
  wayfinderRetry: 'Retry',
  wayfinderListOpen: 'Open',
  wayfinderListClaimed: 'Claimed',
  wayfinderListResolved: 'Resolved',
  wayfinderListOutOfScope: 'Out of scope',
  wayfinderListEmpty: 'No tickets found',
  wayfinderToggleMap: 'Star map',
  wayfinderToggleList: 'List',
  plan: 'Plan',
  planToggleGraph: 'Graph',
  wayfinderListPathHint: 'No .plan found in current directory. Use openTab({ type: "wayfinder", path: "/path/to/.plan" }) to specify a path.',
